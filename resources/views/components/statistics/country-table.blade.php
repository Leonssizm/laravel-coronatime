...
<div class="relative max-w-xs">
    ...
    <form method="GET" action="{{ route('landing-country.index') }}">
            ...
            <tr>
                <th scope="col" class="px-2 lg:px-6 py-3">
                    <div class="flex">
                        ...
                        <form class="flex flex-col ml-2" method="GET">
                            <div x-data="{ isBlack: false }">
                                <a href="{{ route('landing-country.sort', ['sortBy' => 'location', 'sortDirection' => 'asc']) }}" 
                                   x-on:click="isBlack = !isBlack">
                            ...
                            <div x-data="{ isBlack: false }" class="mt-1">
                                <a href="{{ route('landing-country.sort', ['sortBy' => 'location', 'sortDirection' => 'desc']) }}" 
                                   x-on:click="isBlack = !isBlack">
                                    <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <th scope="col" class="px-2 lg:px-6 py-3">
                    <div class="flex">
                        ...
                        <form class="flex flex-col ml-2" method="GET">
                            <div x-data="{ isBlack: false }">
                                <a href="{{ route('landing-country.sort', ['sortBy' => 'new_cases', 'sortDirection' => 'asc']) }}" 
                                   x-on:click="isBlack = !isBlack">
                                    <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5 0.5L10 5.5L0 5.5L5 0.5Z" :fill="isBlack ? 'black' : '#BFC0C4'"/>
                                    </svg>
                            ...
                            <div x-data="{ isBlack: false }" class="mt-1">
                                <a href="{{ route('landing-country.sort', ['sortBy' => 'new_cases', 'sortDirection' => 'desc']) }}" 
                                   x-on:click="isBlack = !isBlack">
                                    <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5 5.5L0 0.5H10L5 5.5Z" :fill="isBlack ? 'black' : '#BFC0C4'"/>
                                    </svg>
                ...
                <th scope="col" class="px-2 lg:px-6 py-3">
                    <div class="flex">
                        ...
                        <form class="flex flex-col ml-2" method="GET">
                            <div x-data="{ isBlack: false }">
                                <a href="{{ route('landing-country.sort', ['sortBy' => 'deaths', 'sortDirection' => 'asc']) }}" 
                                   x-on:click="isBlack = !isBlack">
                                    <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5 0.5L10 5.5L0 5.5L5 0.5Z" :fill="isBlack ? 'black' : '#BFC0C4'"/>
                                    </svg>
                            ...
                            <div x-data="{ isBlack: false }" class="mt-1">
                                <a href="{{ route('landing-country.sort', ['sortBy' => 'deaths', 'sortDirection' => 'desc']) }}" 
                                   x-on:click="isBlack = !isBlack">
                                    <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5 5.5L0 0.5H10L5 5.5Z" :fill="isBlack ? 'black' : '#BFC0C4'"/>
                                    </svg>
                ...
                <th scope="col" class="px-2 lg:px-6 py-3">
                    <div class="flex">
                        ...
                        <form class="flex flex-col ml-2" method="GET">
                            <div x-data="{ isBlack: false }">
                                <a href="{{ route('landing-country.sort', ['sortBy' => 'recovered', 'sortDirection' => 'asc']) }}" 
                                   x-on:click="isBlack = !isBlack">
                                    <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5 0.5L10 5.5L0 5.5L5 0.5Z" :fill="isBlack ? 'black' : '#BFC0C4'"/>
                                    </svg>
                            ...
                            <div x-data="{ isBlack: false }" class="mt-1">
                                <a href="{{ route('landing-country.sort', ['sortBy' => 'recovered', 'sortDirection' => 'desc']) }}" 
                                   x-on:click="isBlack = !isBlack">
                                    <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M5 5.5L0 0.5H10L5 5.5Z" :fill="isBlack ? 'black' : '#BFC0C4'"/>
                                    </svg>
