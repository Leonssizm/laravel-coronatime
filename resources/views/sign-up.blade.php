<x-dashboard-layout>
    <div class="ml-5 mt-10 lg:ml-28 mt-14">
         <h1 class="font-inter text-2xl font-black">Welcome To Coronatime</h1>
         <h3 class="font-inter text-sm font-normal text-[#808189] mt-4">Please enter required info to sign up</h3>
         <div class="mt-6">
            <x-form.sign-up-form/>
        </div>
    </div>
